...
public class AdapterFeito extends Tarefa {

    public AdapterFeito(TarefaFeitaFrag taskFragment) {
        super(taskFragment);
    }
    ...
    private class DoneTaskViewHolder extends TaskViewHolder implements AnimationEndListener {
        ...
        protected void handlePriorityClick(View v) {
            ...
            getTaskFragment().getActivityForTaskFragment().getDbHelper().update().status(task.getTimeStamp(), TarefaModel.STATUS_CURRENT);
