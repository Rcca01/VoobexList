package br.com.voobex.todolist.dialog;
...
public class EditarTarefa extends DialogFragment {

    public static EditarTarefa newInstance(TarefaModel task) {
        EditarTarefa editTaskDialogFragment = new EditarTarefa();
    ...
    public interface EditingTaskListener {
        void onTaskEdited(TarefaModel updatedTask);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final TarefaModel task = new TarefaModel(title, date, priority, 0, timeStamp);
        ...
        View container = inflater.inflate(R.layout.tarefa_dialog, null);
        ...
        ArrayAdapter<String> priorityAdapter = new ArrayAdapter<String>(getActivity(),
                android.R.layout.simple_spinner_dropdown_item, TarefaModel.PRIORITY_LEVELS);
        ...
        etDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DialogFragment datePickerFragment = new Calendario() {
                    @Override
                ...
                datePickerFragment.show(getFragmentManager(), "Calendario");
            }
        });
        ...
        etTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DialogFragment timePickerFragment = new Horario() {
                    @Override
                ...
                timePickerFragment.show(getFragmentManager(), "Horario");
            }
        });
        ...
        builder.setPositiveButton(R.string.dialog_ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                task.setStatus(TarefaModel.STATUS_CURRENT);
                if (etDate.length() != 0 || etTime.length() != 0) {
